## MCDNet: A Multi-way Calibrated Dual-branch Network for Multi-category Semantic Segmentation in Remote Sensing
...
<div>
<img src="1.1.pdf" width="80%"/>
<!-- <img src="pot.png" width="35.5%"/> -->
</div>

- [Welcome to my homepage!](https://github.com/23del)
- The code of [MCDNet](https://github.com/23del/MCDnet/tree/master) is released.
...
**MCDNet** is a dual-branch network for semantic segmentation of high-resolution remote sensing images, combining the local feature extraction of CNN with the global context modeling capability of Transformer. The network effectively improves the segmentation accuracy of small targets and complex boundaries through the multi-directional self-calibration module (MSM) and fine-grained feature alignment module (FFM). It achieved 54.4% and 84.4% mIoU on LoveDA and Vaihingen datasets, respectively, demonstrating superior performance.
...
- Folder Structure
  ...
  - Prepare the following data folders to organize this repo:
    ```none
    MCDNet
    ├── data
    │   ├── LoveDA
...
We wish **MCDNet** could serve the growing research of remote sensing by providing a unified benchmark 
and inspiring researchers to develop their own segmentation networks. Many thanks the following projects's contributions to **MCDNet**.
