...
weights_name = "dcswin-tiny-512crop-ms-epoch30-rcm_cg-loss1.5"
weights_path = "model_weights0/loveda/{}".format(weights_name)  # do not change
test_weights_name = "dcswin-tiny-512crop-ms-epoch30-rcm_cg-loss1.5"  # if save_top_k=3, there are v1,v2 model weights, i.e.xxx-v1, xxx-v2
...
net = dcswin_tiny(num_classes=num_classes, pretrained=True)

# define the loss
loss = JointLoss(SoftCrossEntropyLoss(smooth_factor=0.05, ignore_index=ignore_index),
                 DiceLoss(smooth=0.05, ignore_index=ignore_index), 1.0, 5.0)
