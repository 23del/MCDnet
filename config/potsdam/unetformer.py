...
weights_name = "unetformer-r18-768crop-ms-e45-rcmcg"
weights_path = "model_weights0/potsdam/{}".format(weights_name)
test_weights_name = "unetformer-r18-768crop-ms-e45-rcmcg"
