...
weights_name = "unetformer-r18-512-crop-ms-e105-rcmcg"
weights_path = "model_weights0/vaihingen/{}".format(weights_name)
test_weights_name = "unetformer-r18-512-crop-ms-e105-rcmcg"
