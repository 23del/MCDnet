...
from geoseg.models.UNetFormer import RCM
from PlugNPlay import LocalAttention, EUCB, CBAM, CGAFusion
...
class DCSwin(nn.Module):
    def __init__(self,
                 encoder_channels=(96, 192, 384, 768), #128, 256, 512, 1024  96, 192, 384, 768
                 dropout=0.05,
                 atrous_rates=(6, 12),
                 num_classes=6,
                 embed_dim=128,
        ...
        self.rcm2 = RCM(384)
        self.rcm3 = RCM(768)
        self.cg0 = CGAFusion(96)
        self.cg1 = CGAFusion(192)
        self.cg2 = CGAFusion(384)
        self.cg3 = CGAFusion(768)
        self.eu = EUCB(96,96)
